from LibEER.config.setting import set_setting_by_config
...
def main(args):
    ...
    if args.setting is not None:
        ...
        # 使用命令行参数自定义设置
        setting = set_setting_by_config(args)
...
if __name__ == '__main__':
    ...
    config.update(
        ...
        # 数据集参数
        dataset='seed_raw',
        dataset_path='D:/Study/EEG/LibEER/data_utils/Dataset/SEED',
        sample_length=200,
        stride=200,
        only_seg=True,  # 对应 -only_seg 参数
