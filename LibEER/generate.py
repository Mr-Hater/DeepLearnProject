...
if dataset.startswith("seediv"):
    if server == 128:
        dataset_path = "/LibEER/data_utils/Dataset/SEED_IV"
    else:
        dataset_path = "/LibEER/data_utils/Dataset/SEED_IV"
    if isIn:
    ...
    if server == 128:
        dataset_path = "/LibEER/data_utils/Dataset/SEED"
    else:
        dataset_path = "/LibEER/data_utils/Dataset/SEED"
    if isIn:
    ...
    if server == 128:
        dataset_path = "/LibEER/data_utils/Dataset/DEAP/data_preprocessed_python"
    else:
        dataset_path = "/LibEER/data_utils/Dataset/DEAP/data_preprocessed_python"
    if isIn:
        setting = ""
